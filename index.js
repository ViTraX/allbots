...
console.log(`
        ...
        ╚═════════════════════════════════╝`);
client.user.setActivity('hw!help | highway-mc.tk');
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
    if(command === "") {
        message.channel.send("fais hw!help pour voir toute notre panoplie de commandes");
    }
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
if(command === "restart"){
...
if(command === "rush") {
  ...
  request
  .get(`https://www.lordmorgoth.tk/API/stats?joueur=+${player}+&mode=rush&periode=toujours`)
   var pseudo = JSON.parse(pseudo);
   console.log(`${pseudo}+cc`);
}
...
if(command === "kick") {
    ...
    message.args.send("Your message here.")
    if(!toKick)
...
client.on("guildCreate", guild => {
    ...
    console.log(`[Guild]J ai rejoint un serveur de random: ${guild.name} (id: ${guild.id}). Ce serveur a ${guild.memberCount} membres !`);
  });
 
client.on("guildDelete", guild => {
    // this event triggers when the bot is removed from a guild.
    console.log(`[Guild]J ai quitté le serveur: ${guild.name} (id: ${guild.id})`);
});
//●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
//●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
//●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
